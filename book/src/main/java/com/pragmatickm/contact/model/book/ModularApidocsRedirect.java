...
package com.pragmatickm.contact.model.book;
 ...
 */
@WebServlet("/contact/model/apidocs/com/*")
public class ModularApidocsRedirect extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    HttpServletUtil.sendRedirect(
        ...
        "/contact/model/apidocs/com.pragmatickm.contact.model/com" + Objects.toString(req.getPathInfo(), ""),
